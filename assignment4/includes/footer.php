<?php 
/** 
* This file contains the footer section of the grades page and home page 
* 
* 
* PHP version 7.1 
* 
...
<div class="container">
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    ...
    <ul class="nav col-md-4 justify-content-end">
      ...
      <li class="nav-item"><a href="./aup.php" class="nav-link px-2 text-body-secondary">AUP</a></li>
